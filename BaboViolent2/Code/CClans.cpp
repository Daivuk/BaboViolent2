...
CClans::CClans(CControl * in_parent, CControl * in_alignTo)
{
...
//--- Update it
//
void CClans::updatePerso(float delay)
{
}

void CClans::updateList()
{
}

void CClans::MouseEnter(CControl * control)
{
...
void CClans::MouseLeave(CControl * control)
{
}
void CClans::MouseDown(CControl * control)
{
}
void CClans::MouseUp(CControl * control)
{
}
void CClans::MouseMove(CControl * control)
{
}
void CClans::Click(CControl * control)
{
	if (control->style == "BUTTON")
	{
...
void CClans::Validate(CControl * control)
{
	dksPlaySound(m_sfxClic, -1, 200);
}
void CClans::DbClick(CControl * control)
{
}
