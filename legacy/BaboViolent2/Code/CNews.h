...
#ifndef CNEWS_H_INCLUDED
#define CNEWS_H_INCLUDED


#include "CPanel.h"


class CNews : public CPanel
{
public:
	CControl * parent;
...
public:
	CNews(CControl * in_parent, CControl * in_alignTo);
	virtual ~CNews();
...
private:
	void AddNews(const CString& title, const CString& author, const CString& content, const CString& date);
};
